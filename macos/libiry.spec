...
#
# Usage: pyinstaller macos/libiry.spec
# Output: dist/Libiry.app
# =============================================================================
...
# Hidden imports for Kivy and PIL
hiddenimports = [
    # Kivy core modules
    'kivy.core.window',
    'kivy.core.text',
...
app = BUNDLE(
    coll,
    name='Libiry.app',
    icon=os.path.join(SPEC_ROOT, 'resources', 'icons', 'Libiry.icns'),
    bundle_identifier='org.libiry.libiry',
    info_plist={
        'CFBundleName': 'Libiry',
